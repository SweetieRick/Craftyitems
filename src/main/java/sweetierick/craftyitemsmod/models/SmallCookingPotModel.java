package sweetierick.craftyitemsmod.models;
...
public class SmallCookingPotModel implements UnbakedModel, BakedModel, FabricBakedModel {
    private Mesh mesh;
    private static final SpriteIdentifier[] SPRITE_IDS = new SpriteIdentifier[]{
            new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, new Identifier("craftyitems:block/smallpot_side")),
            new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, new Identifier("craftyitems:block/smallpot_bottom"))
    };
    ...
    public Sprite getParticleSprite() {
        return null; // Block break particle, let's use furnace_top
    }
